                                        ...
                                        <div class="different-address">
                                            ...
                                            <!-- <div id="ship-box-info" class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="checkout-form-list">
                                                        <label>Address <span class="required">*</span></label>
                                                        <input placeholder="Street address" type="text" name="address" value>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="checkout-form-list">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="checkout-form-list">
                                                        <label>State / County <span class="required">*</span></label>
                                                        <input placeholder="" type="text" name="state" value>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="checkout-form-list">
                                            ...
                                            <div class="order-notes">
                                                <div class="checkout-form-list checkout-form-list-2">
                                                    ...
                                                    <textarea id="checkout-mess" cols="30" rows="10" placeholder="Notes about your order, e.g. special notes for delivery." name="checkout-mess"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <table class="table">
                                            ...
                                            @if(Session::has('mini-carts'))
                                                ...
                                                @endphp
                                                    <tr class="cart_item">
                                                        ...
                                                        × {{$product->quantity_cart}}</strong></td>
                                                        <td class="cart-product-total"><span class="amount">${{ $priceEnd }}.00</span></td>
                                                        <input type="hidden" class="cart-plus-minus-box" name="num_product[{{ $product->id }}]" value="{{ $product->quantity_cart }}" >
                                                    </tr>
                                                    <!-- <tr class="cart_item">
                                            ...
                                            <tfoot>
                                                <tr class="cart-subtotal">
                                                    <th>Cart Subtotal</th>
                                                    <td><span class="amount">${{ $sumPriceCart }}.00</span></td>
                                                </tr>
                                                <tr class="order-total">
                                                    <th>Order Total</th>
                                                    <td><strong><span class="amount">${{ $sumPriceCart }}.00</span></strong></td>
                                                </tr>
                                            </tfoot>
                                        </table>
                                    </div>
                                    <div class="payment-method">
                                        <div class="payment-accordion">
                                            ...
                                            <div class="order-button-payment">
                                                <a href="/checkout2"><input  value="Place order" type="submit"></a>
                                                <!-- <button type="submit" class="order-button-payment">
                                                    Place order
                                                </button> -->
